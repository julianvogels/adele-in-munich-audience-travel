...
process_modal_split_data <- function(data) {
    ...
    modal_split_data <- modal_split_data %>%
        mutate(DistanceBucket = case_when(
            ...
            `Itinerary Distance (single journey, km)` > 200 & `Itinerary Distance (single journey, km)` <= 205 ~ "200-205 km",
            `Itinerary Distance (single journey, km)` > 205 & `Itinerary Distance (single journey, km)` <= 210 ~ "205-210 km",
            `Itinerary Distance (single journey, km)` > 210 & `Itinerary Distance (single journey, km)` <= 215 ~ "210-215 km",
            `Itinerary Distance (single journey, km)` > 215 & `Itinerary Distance (single journey, km)` <= 220 ~ "215-220 km",
            `Itinerary Distance (single journey, km)` > 220 & `Itinerary Distance (single journey, km)` <= 225 ~ "220-225 km",
            `Itinerary Distance (single journey, km)` > 225 & `Itinerary Distance (single journey, km)` <= 230 ~ "225-230 km",
            `Itinerary Distance (single journey, km)` > 230 & `Itinerary Distance (single journey, km)` <= 235 ~ "230-235 km",
            `Itinerary Distance (single journey, km)` > 235 & `Itinerary Distance (single journey, km)` <= 240 ~ "235-240 km",
            `Itinerary Distance (single journey, km)` > 240 & `Itinerary Distance (single journey, km)` <= 245 ~ "240-245 km",
            `Itinerary Distance (single journey, km)` > 245 & `Itinerary Distance (single journey, km)` <= 250 ~ "245-250 km",
            `Itinerary Distance (single journey, km)` > 250 & `Itinerary Distance (single journey, km)` <= 255 ~ "250-255 km",
            `Itinerary Distance (single journey, km)` > 255 & `Itinerary Distance (single journey, km)` <= 260 ~ "255-260 km",
            `Itinerary Distance (single journey, km)` > 260 & `Itinerary Distance (single journey, km)` <= 265 ~ "260-265 km",
            `Itinerary Distance (single journey, km)` > 265 & `Itinerary Distance (single journey, km)` <= 270 ~ "265-270 km",
            `Itinerary Distance (single journey, km)` > 270 & `Itinerary Distance (single journey, km)` <= 275 ~ "270-275 km",
            `Itinerary Distance (single journey, km)` > 275 & `Itinerary Distance (single journey, km)` <= 280 ~ "275-280 km",
            `Itinerary Distance (single journey, km)` > 280 & `Itinerary Distance (single journey, km)` <= 285 ~ "280-285 km",
            `Itinerary Distance (single journey, km)` > 285 & `Itinerary Distance (single journey, km)` <= 290 ~ "285-290 km",
            `Itinerary Distance (single journey, km)` > 290 & `Itinerary Distance (single journey, km)` <= 295 ~ "290-295 km",
            `Itinerary Distance (single journey, km)` > 295 & `Itinerary Distance (single journey, km)` <= 300 ~ "295-300 km",
            `Itinerary Distance (single journey, km)` > 300 ~ ">300 km"
        ))
...
modal_split_data <- modal_split_data %>%
    mutate(DistanceBucket = factor(DistanceBucket,
        levels = c(
            ...
            "190-195 km", "195-200 km", "200-205 km", "205-210 km", "210-215 km",
            "215-220 km", "220-225 km", "225-230 km", "230-235 km", "235-240 km",
            "240-245 km", "245-250 km", "250-255 km", "255-260 km", "260-265 km",
            "265-270 km", "270-275 km", "275-280 km", "280-285 km", "285-290 km",
            "290-295 km", "295-300 km", ">300 km"
        )
    ))
...
ggsave("output/modal_split_distance_buckets_de_smooth_300km.png", modal_split_plot, width = 12, height = 8)
...
# Save the plot as an image
ggsave("output/modal_split_distance_buckets_de_300km.png", modal_split_plot, width = 12, height = 8)
